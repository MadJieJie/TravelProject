package com.fengjie.myapplication.utils.algorithm;
...
public class MD5
{
	...
	{
		int num = ( ( str.length() + 8 ) / 64 ) + 1;// ��512λ��64���ֽ�Ϊһ��
		int strByte[] = new int[num * 16];// 64/4=16��������16������
	...
	/**
	 * factory method.
	 * @param source need to switch string.
	 * @return md5 value
	 */
